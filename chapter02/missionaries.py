...
from chapter02.generic_search import bfs, Node, node_to_path
...
def display_solution(path: List[MCState]):
    ...
    for current_state in path[1:]:
        if current_state.boat:
            print(f"{old_state.em - current_state.em} missionaries and"
                  f" {old_state.ec - current_state.ec} moved from the east bank to the west bank.\n")
        else:
            print(f"{old_state.wm - current_state.wm} missionaries and "
